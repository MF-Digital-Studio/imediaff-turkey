...
export default function AffiliateProgramsPage() {
  return (
    <main className="min-h-screen bg-white text-[#111111] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.2em] font-bold text-black hover:text-[#111111] transition-colors w-fit"
              >
            ...
            <motion.div
              {...fadeUp(0.2)}
              className="group relative p-8 md:p-12 bg-[#FE9417] border border-[#E5E5E5] transition-all duration-300 flex flex-col justify-between overflow-hidden text-black"
            >
              <div>
                <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                  <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            >
              <div>
                ...
                <p className="font-mono text-[10px] text-[#555555] font-bold uppercase tracking-wider mb-6">Active since October 2024</p>
              ...
              <Link
                href="/talent/cee"
                className="inline-flex items-center gap-1.5 font-mono text-xs uppercase tracking-[0.2em] font-bold text-[#111111] hover:text-[#FE9417] transition-colors mt-auto"
              >
                View CEE Program
                <span className="transition-transform duration-300 group-hover:translate-x-1">→</span>
              </Link>
            ...
            >
              <div>
                ...
                <p className="font-mono text-[10px] text-[#555555] font-bold uppercase tracking-wider mb-6">Active Region</p>
                <p className="text-[#111111] leading-relaxed font-sans mb-8 text-sm">
              ...
              <div>
                ...
                <div className="space-y-4 border-t border-[#E5E5E5] pt-6 mb-10">
                  {[
                    ...
                    <div key={index} className="flex items-start gap-3">
                      <Link2 className="w-4 h-4 text-[#111111] mt-0.5 flex-shrink-0" />
                      <span className="text-xs text-[#555555] font-medium leading-relaxed">{feat}</span>
                    </div>
                  ))}
                </div>
      ...
      <section id="noon-program" className="py-24 md:py-32 bg-[#FE9417] text-black relative overflow-hidden">
        <div className="mx-auto max-w-[1600px] px-6 md:px-10">
            ...
            >
              ...
              <div className="flex items-center justify-between border-t border-white/[0.06] pt-6 mt-8">
                <div className="flex items-center gap-4">
                  <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center font-mono text-xs text-[#111111] font-bold">N</div>
                  <span className="font-sans text-xs text-[#555555] font-semibold uppercase tracking-wider">Noon × iMediaff Global</span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                key={f.title}
                {...fadeUp(index * 0.12)}
                className="group relative rounded-2xl p-8 bg-black/5 backdrop-blur-sm border border-black/10 hover:bg-black/5 transition-all duration-500 flex flex-col justify-between"
              >
                ...
                <div>
                  <div className="mb-6 w-12 h-12 rounded-xl bg-black/5 border border-black/15 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
          ...
          <div className="mt-14 flex justify-center">
            <Link
              ...
              className="group inline-flex items-center justify-center rounded-full px-8 py-4 bg-white text-[#FE9417] hover:bg-white hover:text-[#FE9417] transition-all hover:scale-105 shadow-xl font-bold"
            >
      ...
      <section className="py-24 md:py-32 border-b border-white/[0.08] relative bg-white/[0.01]">
        <div className="mx-auto max-w-[1600px] px-6 md:px-10">
          <motion.div {...fadeUp(0)} className="mb-16 md:mb-24 text-center">
            ...
            <h2 className="mt-5 font-display text-[clamp(2.5rem,5vw,5.5rem)] font-bold leading-[0.92] tracking-[-0.04em] text-[#111111]">
              Find Your Program.
            </h2>
          </motion.div>
          ...
          >
            <table className="w-full min-w-[800px] border-collapse text-left text-sm">
              ...
              <tbody className="divide-y divide-white/[0.04] font-medium text-[#555555]">
                <tr className="bg-white/[0.01] hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Regions</td>
                ...
                <tr className="bg-transparent hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Min. Followers</td>
                ...
                <tr className="bg-white/[0.01] hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Commission Model</td>
                ...
                <tr className="bg-transparent hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Max Commission</td>
                ...
                <tr className="bg-white/[0.01] hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Cookie Window</td>
                ...
                <tr className="bg-transparent hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Payment Currency</td>
                ...
                <tr className="bg-white/[0.01] hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Contract</td>
                ...
                <tr className="bg-transparent hover:bg-white/[0.03] transition-colors">
                  <td className="p-6 font-semibold text-[#111111]">Agency Required</td>
