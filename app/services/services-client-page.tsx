...
export default function ServicesClientPage() {
  return (
    <main className="min-h-screen bg-white text-[#111111]">
      ...
      <section className="bg-[#FB430A] text-white border-b border-white/20 pt-32 pb-16 md:pt-48 md:pb-24 relative overflow-hidden">
        <motion.div
        ...
        >
          ...
          <h1 className="mt-6 font-display text-[clamp(2.5rem,8vw,8rem)] font-bold leading-[0.9] tracking-[-0.04em] text-balance text-white">
            Sadece Büyüme Değil, Dönüşüm.
          </h1>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/90 md:text-xl font-sans">
      ...
      <section className="bg-white text-[#111111] border-b border-[#E5E5E5] py-16 md:py-32 relative overflow-hidden">
        <div className="mx-auto max-w-[1600px] px-6 md:px-10 relative z-10">
          ...
          >
            ...
            <h2 className="mt-5 font-display text-[clamp(2.5rem,6vw,5.5rem)] font-bold leading-[0.92] tracking-[-0.04em] text-balance text-[#111111]">
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`w-[90%] md:w-1/2 lg:w-5/12 -mt-20 md:mt-0 relative z-20 rounded-[2rem] bg-white/80 backdrop-blur-2xl border border-[#E5E5E5] p-8 md:p-14 shadow-xl ${isEven ? "md:-ml-24 lg:-ml-32" : "md:-mr-24 lg:-mr-32"}`}
                  >
                    <p className="font-mono text-xs uppercase tracking-[0.3em] text-[#FB430A] mb-6 font-bold">
                      / {String(i + 1).padStart(2, '0')}
                    </p>
                    <h3 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold tracking-[-0.03em] text-[#111111] mb-6 leading-[1.05]">
                      {service.title}
                    </h3>
                    <p className="text-base md:text-lg leading-relaxed text-[#555555] font-sans mb-10">
                      {service.description}
                    </p>
                    ...
                    <div className="flex flex-col gap-5">
                      {service.features.map(feat => (
                        <div key={feat} className="flex items-center gap-4 group/feat">
                          <div className="h-px w-6 bg-[#E5E5E5] transition-all duration-300 group-hover/feat:w-10 group-hover/feat:bg-gradient-to-r group-hover/feat:from-[#FB430A] group-hover/feat:to-[#FB430A]" />
                          <span className="font-mono text-[11px] md:text-xs uppercase tracking-[0.15em] text-[#888888] font-bold transition-colors duration-300 group-hover/feat:text-[#111111]">
                            {feat}
                          </span>
                        </div>
                      ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {PROCESS.map((step, i) => (
              ...
              >
                ...
                {i < PROCESS.length - 1 && (
                  <div className="hidden md:block absolute top-6 left-12 w-full h-[1px] bg-white/10 group-hover:bg-[#FB430A]/50 transition-colors duration-500" />
                )}

                <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full border border-[#E5E5E5] bg-white font-mono text-sm text-[#FB430A] transition-colors duration-500 group-hover:border-[#FB430A] group-hover:text-[#FB430A] mb-6">
                  {step.step}
                </div>
