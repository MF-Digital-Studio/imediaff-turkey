      ...
      <section className="py-24 border-border bg-[#ffffff] border-t border-[#e5e7eb] border-b border-[#e5e7eb] relative">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Card 1 — CEE Region */}
            <Link href="/talent/cee" className="group flex flex-col bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl hover:bg-[#f3f4f6] hover:border-[#FE9417]/50 transition-all duration-300 relative overflow-hidden">
              ...
              <div className="flex flex-wrap gap-1.5 mb-4 z-10">
                <span className="px-2.5 py-0.5 text-xs font-bold bg-[#FE9417]/10 text-[#FE9417] rounded-full">CEE</span>
              ...
              <h3 className="text-2xl font-bold mb-2 text-[#111827] group-hover:text-[#FE9417] transition-colors">CEE Region</h3>
              ...
              <div className="flex items-center text-sm font-bold text-[#FE9417] group-hover:text-[#1d4ed8] transition-colors mt-auto">
                View Program <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </div>
            </Link>

            {/* Card 2 — Gulf Region */}
            <Link href="/talent/gulf" className="group flex flex-col bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl hover:bg-[#f3f4f6] hover:border-[#FE9417]/50 transition-all duration-300 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FE9417]/5 blur-2xl rounded-full group-hover:bg-[#FE9417]/10 transition-colors" />
              <div className="flex flex-wrap gap-1.5 mb-4 z-10">
                <span className="px-2.5 py-0.5 text-xs font-bold bg-[#FE9417]/10 text-[#FE9417] rounded-full">MENA</span>
              ...
              <h3 className="text-2xl font-bold mb-2 text-[#111827] group-hover:text-[#FE9417] transition-colors">Gulf Region</h3>
            ...
            {/* Card 3 — Turkey */}
            <Link href="/talent/turkey" className="group flex flex-col bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl hover:bg-[#f3f4f6] hover:border-[#FE9417]/50 transition-all duration-300 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FE9417]/5 blur-2xl rounded-full group-hover:bg-[#FE9417]/10 transition-colors" />
              <div className="flex flex-wrap gap-1.5 mb-4 z-10">
                <span className="px-2.5 py-0.5 text-xs font-bold bg-[#FF6B00]/10 text-[#FF6B00] rounded-full">Turkey</span>
              ...
              <h3 className="text-2xl font-bold mb-2 text-[#111827] group-hover:text-[#FE9417] transition-colors">Turkey</h3>
            ...
            {/* Card 4 — Azerbaijan */}
            <Link href="/talent/azerbaijan" className="group flex flex-col bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl hover:bg-[#f3f4f6] hover:border-[#FE9417]/50 transition-all duration-300 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FE9417]/5 blur-2xl rounded-full group-hover:bg-[#FE9417]/10 transition-colors" />
              <div className="flex flex-wrap gap-1.5 mb-4 z-10">
                <span className="px-2.5 py-0.5 text-xs font-bold bg-[#FE9417]/10 text-[#FE9417] rounded-full">Azerbaijan</span>
              ...
              <h3 className="text-2xl font-bold mb-2 text-[#111827] group-hover:text-[#FE9417] transition-colors">Azerbaijan</h3>
