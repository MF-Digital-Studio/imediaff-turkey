  ...
  return (
    <main className="bg-background text-foreground min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 bg-white/5 border border-[#E5E5E5] p-5 rounded-2xl">
                  <div className="p-3 bg-[#FE9417]/10 rounded-xl"><item.icon className="w-6 h-6 text-[#FE9417]" /></div>
                  <p className="text-foreground/90 font-medium">{item.text}</p>
                </div>
              ))}
            </div>
            <div className="relative border border-[#E5E5E5] bg-white/5 backdrop-blur-xl p-10 rounded-3xl overflow-hidden text-center flex items-center justify-center min-h-[300px]">
              <div className="absolute inset-0 bg-gradient-to-br from-[#FE9417]/20 to-[#FE9417]/20 blur-3xl rounded-full opacity-50" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="border border-[#E5E5E5] bg-white/5 p-8 rounded-2xl flex flex-col">
                <req.icon className="w-8 h-8 text-[#FE9417] mb-4" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl relative overflow-hidden group">
              ...
              <ShoppingBag className="w-10 h-10 text-[#FE9417] mb-6" />
            ...
            <div className="bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FE9417]/5 blur-2xl rounded-full group-hover:bg-[#FE9417]/10 transition-colors" />
              <TrendingUp className="w-10 h-10 text-[#FE9417] mb-6" />
            ...
            <div className="bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FE9417]/5 blur-2xl rounded-full group-hover:bg-[#FE9417]/10 transition-colors" />
              <BarChart className="w-10 h-10 text-[#FE9417] mb-6" />
      ...
      <section className="py-24 border-border bg-[#ffffff] relative overflow-hidden">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            <div className="border border-[#FF6B00] bg-[#f0fdf4] text-[#FF6B00] p-8 rounded-2xl flex flex-col justify-center relative overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FF6B00]/10 blur-2xl rounded-full" />
              <div className="text-2xl mb-4 font-bold flex items-center gap-2 text-[#FF6B00]">🌱 Starter</div>
              <p className="text-[#15803d] text-sm mb-3">Entry segment for new joiners. Welcome rates apply for the first month:</p>
              <ul className="space-y-1 text-sm text-[#FF6B00] font-semibold">
          ...
          <div className="p-6 border border-[#bfdbfe] bg-[#eff6ff] rounded-xl flex items-start gap-4 shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
            <AlertCircle className="w-6 h-6 text-[#FE9417] shrink-0" />
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
            ...
            <div className="border border-[#e5e7eb] bg-[#f9fafb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 md:p-10 rounded-3xl relative overflow-hidden">
              ...
              <p className="text-lg text-[#FE9417] mb-6 font-medium">
          ...
          <div className="bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-10 rounded-3xl max-w-4xl mb-8">
            ...
            <div className="space-y-4 text-lg">
              ...
              <div className="flex justify-between items-center py-4 mt-2">
                ...
                <span className="text-3xl font-display font-bold text-[#FF6B00]">₺7,000</span>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 border-border bg-[#ffffff] relative overflow-hidden">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-8 rounded-3xl">
              <Building2 className="w-10 h-10 text-[#FE9417] mb-6" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-10 rounded-3xl">
              <FileLock2 className="w-10 h-10 text-[#FE9417] mb-6" />
            ...
            <div className="bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-10 rounded-3xl">
              <Coins className="w-10 h-10 text-[#FE9417] mb-6" />
              ...
              <ul className="space-y-3 text-[#4b5563] leading-relaxed mb-4 text-sm md:text-base">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#FF6B00] shrink-0" /> <span>Agency service fee: 15% of total commission earned.</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#FF6B00] shrink-0" /> <span>Mandatory withholding tax: 15% (deducted by law).</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#FF6B00] shrink-0" /> <span>Net payment sent to your IBAN after all deductions.</span></li>
              </ul>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#eff6ff] border border-[#bfdbfe] rounded-full text-sm font-semibold text-[#FE9417]">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4 p-6 bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] rounded-2xl">
              <Headphones className="w-8 h-8 text-[#FE9417] shrink-0" />
              <div>
            ...
            <div className="flex items-start gap-4 p-6 bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] rounded-2xl">
              <MessageCircle className="w-8 h-8 text-[#FE9417] shrink-0" />
              <div>
            ...
            <div className="flex items-start gap-4 p-6 bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] rounded-2xl">
              <Building2 className="w-8 h-8 text-[#FE9417] shrink-0" />
              <div>
            ...
            <div className="flex items-start gap-4 p-6 bg-[#f9fafb] border border-[#e5e7eb] shadow-[0_1px_4px_rgba(0,0,0,0.06)] rounded-2xl">
              <Scale className="w-8 h-8 text-[#FE9417] shrink-0" />
              <div>
      ...
      <section className="py-24 border-border bg-white border-b border-[#E5E5E5]">
        ...
        >
          <ShieldCheck className="w-16 h-16 text-[#FE9417] mb-6" />
